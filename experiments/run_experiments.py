...
def build_methods():
    ...
    return {
        ...
        "Adaptive": AdaptiveSnake(
            ...
            gamma=100.0, sigma=2.0, n_iter=500, update_every=20, wedge=1.0
        ),
        "Multiscale": MultiscaleSnake(
            alpha=0.015, beta=0.1, gamma=0.001, sigma_coarse=8.0,
            n_levels=3, n_iter=2500, wedge=1.0
        ),
        "Combined": CombinedSnake(
            alpha=0.015, beta_min=0.005, beta_max=0.3, k=5.0,
            gamma=100.0, sigma=2.0, n_iter=500, update_every=20,
            sigma_coarse=8.0, n_levels=3, wedge=1.0
        ),
    }
